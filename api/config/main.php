    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'POST dict/select-options' => 'dict/select-options',
                ...
                // 钉钉用户
                'POST dingtalk/employee-index' => 'ding-talk/employee-index',
                'POST dingtalk/employee-sync' => 'ding-talk/employee-sync',

                'POST customer/index' => 'customer/index',
                'POST customer/select-options' => 'customer/select-options',
                'POST customer/view' => 'customer/view',
                'POST customer/create' => 'customer/create',
                'POST customer/update' => 'customer/update',
                'POST customer/delete' => 'customer/delete',
                'POST customer-contact/index' => 'customer-contact/index',
                ...
                'POST product-category/index' => 'product-category/index',
                'POST product-category/tree' => 'product-category/tree',
                'POST product-category/select-options' => 'product-category/select-options',
                'POST product-category/view' => 'product-category/view',
                'POST product-category/create' => 'product-category/create',
                'POST product-category/update' => 'product-category/update',
                'POST product-category/delete' => 'product-category/delete',

                'POST manuscript/index' => 'manuscript/index',
                'POST manuscript/select-options' => 'manuscript/select-options',
                'POST manuscript/view' => 'manuscript/view',
                'POST manuscript/create' => 'manuscript/create',
                'POST manuscript/update' => 'manuscript/update',
                'POST manuscript/delete' => 'manuscript/delete',

                'POST fulfillment/index' => 'fulfillment/index',
                'POST fulfillment/select-options' => 'fulfillment/select-options',
                'POST fulfillment/view' => 'fulfillment/view',
                'POST fulfillment/executions' => 'fulfillment/executions',
                'POST fulfillment/create' => 'fulfillment/create',
                'POST fulfillment/update' => 'fulfillment/update',
                'POST fulfillment/delete' => 'fulfillment/delete',
                'POST fulfillment/create-execution' => 'fulfillment/create-execution',

                'POST contract/index' => 'contract/index',
                'POST contract/select-options' => 'contract/select-options',
                'POST contract/view' => 'contract/view',
                'POST contract/products' => 'contract/products',
                'POST contract/create' => 'contract/create',
                'POST contract/update' => 'contract/update',
                'POST contract/delete' => 'contract/delete',

                'POST receivable/plan-index' => 'receivable/plan-index',
                'POST receivable/record-index' => 'receivable/record-index',
                'POST receivable/select-options' => 'receivable/select-options',
                'POST receivable/plan-view' => 'receivable/plan-view',
                'POST receivable/plan-create' => 'receivable/plan-create',
                'POST receivable/plan-update' => 'receivable/plan-update',
                'POST receivable/plan-delete' => 'receivable/plan-delete',
                'POST receivable/record-create' => 'receivable/record-create',
                'POST receivable/record-update' => 'receivable/record-update',
                'POST receivable/record-delete' => 'receivable/record-delete',
                [
